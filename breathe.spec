...
Source0  : https://files.pythonhosted.org/packages/84/c3/1c99ee90f3deba996087d5cafafbf8d9878918974d2ebc7b49073b847c51/breathe-4.22.1.tar.gz
...
%prep
%setup -q -n breathe-4.22.1
cd %{_builddir}/breathe-4.22.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601311623
